...
def request_api(method, url_path, query="", body=""):
    ...
    # We must sort the query parameters!
    if query:
...
ancestor_guid = first.get('ancestor_guid')

endpoints_to_test = [
    ("/v/api/v1/item/detail", "GET", f"guid={media_guid}&mediadb_guid={ancestor_guid}", ""),
    ("/v/api/v1/item/detail", "GET", f"guid={guid}&mediadb_guid={ancestor_guid}", ""),
    ("/v/api/v1/item/detail", "GET", f"media_guid={media_guid}&mediadb_guid={ancestor_guid}", ""),
    ("/v/api/v1/play/info", "GET", f"media_guid={media_guid}&mediadb_guid={ancestor_guid}", ""),
]
