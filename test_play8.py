...
res = request_api("POST", "/v/api/v1/item/detail", body=json.dumps({"guid": media_guid}))
if res:
    print("POST /item/detail ->", json.dumps(res, ensure_ascii=False))
else:
    print("POST /item/detail -> Failed")
