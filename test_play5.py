...
lib_guid = "2ca6c43d7fc14f5991f863e0a36e7f94"
guid = "aef573ed10aa4c64ba5032bb4a732aed" # From previous test

endpoints_to_test = [
    ("/v/api/v1/item/detail", "GET", f"guid={guid}&mediadb_guid={lib_guid}", ""),
    ("/v/api/v1/item/detail", "POST", "", json.dumps({"guid": guid, "mediadb_guid": lib_guid})),
]
