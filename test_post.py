...
endpoints_to_test = [
    ("/v/api/v1/item/detail", "GET", f"guid={media_guid}", ""),
    ("/v/api/v1/item/detail", "POST", "", json.dumps({"guid": media_guid})),
    ("/v/api/v1/item/detail", "POST", "", json.dumps({"media_guid": media_guid})),
    ("/v/api/v1/mediadb/movie/detail", "POST", "", json.dumps({"guid": media_guid})),
    ("/v/api/v1/movie/detail", "POST", "", json.dumps({"guid": media_guid})),
    ("/v/api/v1/play/info", "POST", "", json.dumps({"media_guid": media_guid})),
    ("/v/api/v1/play/source", "POST", "", json.dumps({"media_guid": media_guid})),
    ("/v/api/v1/play/detail", "POST", "", json.dumps({"media_guid": media_guid})),
]
