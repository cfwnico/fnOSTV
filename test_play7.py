...
endpoints_to_test = [
    ...
    ("/v/api/v1/play/media", "GET", f"media_guid={media_guid}", ""),
    ("/v/api/v1/play/url", "GET", f"media_guid={media_guid}", ""),
    ("/v/api/v1/item/play", "GET", f"guid={media_guid}", ""),
    ("/v/api/v1/play/detail", "GET", f"guid={media_guid}", ""),
]
